...
use winapi::shared::hidpi::{HidP_GetCaps, HIDP_STATUS_SUCCESS};
...
use winapi::um::setupapi::{
    ...
    SetupDiGetDeviceInterfaceDetailA, SetupDiGetDeviceRegistryPropertyA, DIGCF_DEVICEINTERFACE,
    DIGCF_PRESENT, SPDRP_CLASS, SPDRP_DRIVER, SP_DEVICE_INTERFACE_DATA,
...
fn get_hid_device_info_list() -> Vec<HidDeviceInfo> {
